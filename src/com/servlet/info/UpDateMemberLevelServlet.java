...
@WebServlet("/UpDateMemberLevelServlet")
public class UpDateMemberLevelServlet extends HttpServlet {

    /**
     * Constructor of the object.
     */
    public UpDateMemberLevelServlet() {
        super();
    }
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int num=MemUtils.updateStatus(info.getMail(),info.getLevel(),SQL.updateLevel);
            if(num!=1){
